...
public class MaterialDialogAct extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_md_material_dialog);
    }
    ...
    public void show(View v) {
        if (mMaterialDialog != null) {
            mMaterialDialog.setTitle("MaterialDialog")
                    ...
                    //mMaterialDialog.setBackgroundResource(R.drawable.md_background);
        ...
        switch (v.getId()) {
                ...
                if (mMaterialDialog != null) {
                    if (i % 2 != 0) {
                        mMaterialDialog.setBackgroundResource(
                                R.mipmap.md_background);
                    } else {
                        Resources res = getResources();
                        Bitmap bmp = BitmapFactory.decodeResource(res,
                                R.mipmap.md_background2);
            ...
            case R.id.button_set_contentViewById: {
                final MaterialDialog alert = new MaterialDialog(this).setTitle(
                        "MaterialDialog")
                        .setContentView(
                                R.layout.layout_md_custom_message_content);
