package com.pepe.md.materialtoolbar;
...
public class ProgressBarCircular extends RelativeLayout {
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        //Set md_background Color
        // Color by resource
        int bacgroundColor = attrs.getAttributeResourceValue(ANDROIDXML, "md_background", -1);
        if (bacgroundColor != -1) {
            setBackgroundColor(getResources().getColor(bacgroundColor));
        } else {
            // Color by hexadecimal
            String background = attrs.getAttributeValue(ANDROIDXML, "md_background");
            if (background != null)
