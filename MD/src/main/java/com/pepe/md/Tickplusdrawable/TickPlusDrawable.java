package com.pepe.md.Tickplusdrawable;
...
public class TickPlusDrawable extends Drawable {
    ...
    private Property<TickPlusDrawable, Float> mRotationProperty = new Property<TickPlusDrawable, Float>(Float.class, "md_rotation") {
        @Override
