...
public class ListViewFragment extends BaseRefreshFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_md_list_view, container, false);

        ListView listView = (ListView) rootView.findViewById(R.id.list_view);
        listView.setAdapter(new SampleAdapter(getActivity(), R.layout.item_md_list, mSampleList));
    ...
    class SampleAdapter extends ArrayAdapter<Map<String, Integer>> {
        ...
        public View getView(final int position, View convertView, @NonNull ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = mInflater.inflate(R.layout.fragment_md_list_item, parent, false);
