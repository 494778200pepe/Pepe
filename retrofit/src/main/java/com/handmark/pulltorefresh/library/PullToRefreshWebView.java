...
import com.zizizizizi.retrofitdemo.R;
...
public class PullToRefreshWebView extends PullToRefreshBase<WebView> {
	...
	protected boolean isReadyForPullEnd() {
        ...
        Double exactContentHeight = Double.valueOf(mRefreshableView.getContentHeight() * mRefreshableView.getScale());
	...
	final class InternalWebViewSDK9 extends WebView {
		...
		private int getScrollRange() {
			return (int) Math.max(0, Double.valueOf(mRefreshableView.getContentHeight() * mRefreshableView.getScale())
